...
export function BottomNavSelection({ count, onEdit, onDelete, onCancel }: BottomNavSelectionProps) {
  return (
    <div className="fixed bottom-0 inset-x-0 bg-card/95 backdrop-blur-md border-t border-border shadow-lg z-50 pb-safe">
      <div className="max-w-4xl mx-auto px-4 py-2 max-h-[80vh] overflow-y-auto">
        {/* Counter */}
