    ...
    <div className="fixed bottom-0 left-0 right-0 bg-card/95 backdrop-blur-md border-t border-border shadow-lg z-50">
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 py-3">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4">
          <button
            onClick={onCancel}
            className="h-12 sm:h-14 px-2 rounded-lg font-semibold text-xs sm:text-sm bg-card text-text hover:bg-gray-100 dark:hover:bg-gray-800 transition-all flex items-center justify-center border border-border active:scale-95"
